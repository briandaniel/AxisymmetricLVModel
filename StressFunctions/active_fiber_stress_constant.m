function [ Sf_const_prol ] = active_fiber_stress_constant( At, km, kp, m, ...
                        ell, ell0, eps_ed, Q, F )
...
% are zero)
sigmaF = At.*km.*(1+m.*eps_f).*(1+kp.*eps_ed);
...
Sf_const_prol = tensor_rotate_fiber_to_prolate(Q,Sf_const_fib);
